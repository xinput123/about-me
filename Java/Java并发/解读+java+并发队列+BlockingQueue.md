...
转自 [java 并发队列 BlockingQueue](https://javadoop.com/post/java-concurrent-queue)
...
如果读者看过之前写的《[一行一行源码分析清楚 AbstractQueuedSynchronizer（二）](https://github.com/xinput123/about-me/blob/main/Java/Java%E5%B9%B6%E5%8F%91/%E4%B8%80%E8%A1%8C%E4%B8%80%E8%A1%8C%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90%E6%B8%85%E6%A5%9A%2BAbstractQueuedSynchronizer%2B(%E4%BA%8C).md)》 的关于 Condition 的文章的话，那么你一定能很容易看懂 ArrayBlockingQueue  的源码，它采用一个 ReentrantLock 和相应的两个 Condition 来实现。
...
![array-blocking-queue](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-1.png)
...
更具体的源码我就不进行分析了，因为它就是 AbstractQueuedSynchronizer 中 Condition 的使用，感兴趣的读者请看《[一行一行源码分析清楚 AbstractQueuedSynchronizer（二）](https://github.com/xinput123/about-me/blob/main/Java/Java%E5%B9%B6%E5%8F%91/%E4%B8%80%E8%A1%8C%E4%B8%80%E8%A1%8C%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90%E6%B8%85%E6%A5%9A%2BAbstractQueuedSynchronizer%2B(%E4%BA%8C).md)》，因为只要看懂了那篇文章，ArrayBlockingQueue 的代码就没有分析的必要了，当然，如果你完全不懂 Condition，那么基本上也就可以说看不懂 ArrayBlockingQueue 的源码了。
...
![linked-blocking-queue](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-2.png)
...
![synchronous-queue](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-3.png)
...
![priority-blocking-queue-1](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-4.png)
...
![priority-blocking-queue-2](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-5.png)
...
![priority-blocking-queue-3](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-6.png)
...
![priority-blocking-queue-4](https://xinput-base.pek3b.qingstor.com/images/queue/array-queue-7.png)
